...
#----- PROTECTED REGION ID(Watchdog.additionnal_import) ENABLED START -----#
from Dog import Dog
...
#----- PROTECTED REGION END -----#	//	Watchdog.additionnal_import
...
class Watchdog (PyTango.Device_4Impl):
    ...
    #----- PROTECTED REGION ID(Watchdog.global_variables) ENABLED START -----#
    ...
    def _processDevicesListProperty(self):
        '''This method works with the raw input in the property DevicesList
           ...
           event subscriptions.
        '''
        self.info_stream("In %s::_processDevicesListProperty()"\
                         " DevicesList = '%s'"%(self.get_name(),self.DevicesList))
            ...
            for j in range(len(subline)):
                if len(subline[j])>0:
                    try:
                        ...
                        self.error_stream\
                            ("In %s::_processDevicesListProperty() "
        ...
        for devName in self.DevicesDict.keys():
            ...
            self.add_attribute(dynAttr,
                               ...
                               is_allo_meth=
                                Watchdog.is_oneDeviceState_allowed)
    ...
    def isInRunningLst(self, who):
        self.isInLst(self.attr_RunningDevicesList_read, who)
    ...
    def isInFaultLst(self, who):
        self.isInLst(self.attr_FaultDevicesList_read, who)
    ...
    def isInHangLst(self, who):
        self.isInLst(self.attr_HangDevicesList_read, who)
    ...
    #----- PROTECTED REGION END -----#	//	Watchdog.global_variables

    def __init__(self,cl, name):
        PyTango.Device_4Impl.__init__(self,cl,name)
        self.debug_stream("In __init__()")
        Watchdog.init_device(self)
        #----- PROTECTED REGION ID(Watchdog.__init__) ENABLED START -----#

        #----- PROTECTED REGION END -----#	//	Watchdog.__init__
        
    def delete_device(self):
        self.debug_stream("In delete_device()")
        #----- PROTECTED REGION ID(Watchdog.delete_device) ENABLED START -----#
        self._joinerEvent.set()
        # TODO: check the stop process for each of the dogs
        #----- PROTECTED REGION END -----#	//	Watchdog.delete_device
    ...
    def init_device(self):
        ...
        self.attr_FaultDevicesList_read = ['']
        self.attr_HangDevicesList_read = ['']
        #----- PROTECTED REGION ID(Watchdog.init_device) ENABLED START -----#
        #---- set the vbles ----
        self.DevicesDict = {}
        self.attr_RunningDevicesList_read = []
        self.attr_FaultDevicesList_read = []
        ...
        #----- PROTECTED REGION END -----#	//	Watchdog.init_device

    def always_executed_hook(self):
        self.debug_stream("In always_excuted_hook()")
        #----- PROTECTED REGION ID(Watchdog.always_executed_hook) ENABLED START -----#
        
        #----- PROTECTED REGION END -----#	//	Watchdog.always_executed_hook
    ...
    def read_RunningDevices(self, attr):
        ...
        #----- PROTECTED REGION ID(Watchdog.RunningDevices_read) ENABLED START -----#
        attr.set_value(self.attr_RunningDevices_read)
        
        #----- PROTECTED REGION END -----#	//	Watchdog.RunningDevices_read
        
    def read_FaultDevices(self, attr):
        self.debug_stream("In read_FaultDevices()")
        #----- PROTECTED REGION ID(Watchdog.FaultDevices_read) ENABLED START -----#
        attr.set_value(self.attr_FaultDevices_read)
        
        #----- PROTECTED REGION END -----#	//	Watchdog.FaultDevices_read
        
    def read_HangDevices(self, attr):
        self.debug_stream("In read_HangDevices()")
        #----- PROTECTED REGION ID(Watchdog.HangDevices_read) ENABLED START -----#
        attr.set_value(self.attr_HangDevices_read)
        
        #----- PROTECTED REGION END -----#	//	Watchdog.HangDevices_read
        
    def read_RunningDevicesList(self, attr):
        self.debug_stream("In read_RunningDevicesList()")
        #----- PROTECTED REGION ID(Watchdog.RunningDevicesList_read) ENABLED START -----#
        attr.set_value(self.attr_RunningDevicesList_read)
        
        #----- PROTECTED REGION END -----#	//	Watchdog.RunningDevicesList_read
        
    def read_FaultDevicesList(self, attr):
        self.debug_stream("In read_FaultDevicesList()")
        #----- PROTECTED REGION ID(Watchdog.FaultDevicesList_read) ENABLED START -----#
        attr.set_value(self.attr_FaultDevicesList_read)
        
        #----- PROTECTED REGION END -----#	//	Watchdog.FaultDevicesList_read
        
    def read_HangDevicesList(self, attr):
        self.debug_stream("In read_HangDevicesList()")
        #----- PROTECTED REGION ID(Watchdog.HangDevicesList_read) ENABLED START -----#
        attr.set_value(self.attr_HangDevicesList_read)
        
        #----- PROTECTED REGION END -----#	//	Watchdog.HangDevicesList_read
        
    
    
        #----- PROTECTED REGION ID(Watchdog.initialize_dynamic_attributes) ENABLED START -----#
    def initialize_dynamic_attributes(self):
        pass
        #----- PROTECTED REGION END -----#	//	Watchdog.initialize_dynamic_attributes
            
    def read_attr_hardware(self, data):
        self.debug_stream("In read_attr_hardware()")
        #----- PROTECTED REGION ID(Watchdog.read_attr_hardware) ENABLED START -----#
        
        #----- PROTECTED REGION END -----#	//	Watchdog.read_attr_hardware
...
class WatchdogClass(PyTango.DeviceClass):
    ...
    #----- PROTECTED REGION ID(Watchdog.global_class_variables) ENABLED START -----#
    
    #----- PROTECTED REGION END -----#	//	Watchdog.global_class_variables
    ...
    def dyn_attr(self, dev_list):
        ...
        #----- PROTECTED REGION ID(Watchdog.dyn_attr) ENABLED START -----#
        
        #----- PROTECTED REGION END -----#	//	Watchdog.dyn_attr
    ...
    device_property_list = {
        ...
        'SectorsList':
            [PyTango.DevVarStringArray,
            "Dictionary convertible string with sectors as key and the item is a list of tags from the DeviceList.",
            [] ],
        'TryFaultRecover':
            [PyTango.DevBoolean,
